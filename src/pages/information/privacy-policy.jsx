      ...
      <section className="space-y-6">
        <article>
          ...
          <p className="leading-relaxed text-justify">
            ...
            your data when you use our multivendor marketplace platform.
          </p>
        </article>
        ...
        <article>
          ...
          <p className="leading-relaxed text-justify">
            We collect information that you provide during registration, purchases,
            and communication with vendors and support. This may include your name,
            email address, payment details, and shipping information.
          </p>
        </article>
        ...
        <article>
          ...
          <p className="leading-relaxed text-justify">
            Your data is used to facilitate transactions, improve our services, and
            communicate important updates. We do not sell your personal information
            to third parties.
          </p>
        </article>
        ...
        <article>
          ...
          <p className="leading-relaxed text-justify">
            For any questions about this Privacy Policy, please reach out to our
