      ...
      <section className="space-y-6">
        <article>
          ...
          <p className="leading-relaxed text-justify">
            Welcome to our multivendor marketplace platform. By accessing or using
        ...
        <article>
          <h2 className="text-2xl font-semibold mb-3">2. Vendor Responsibilities</h2>
          <p className="leading-relaxed text-justify">
            Vendors must provide accurate and truthful information about their
            products. They are responsible for ensuring timely delivery and quality
            of goods.
          </p>
        </article>

        <article>
          <h2 className="text-2xl font-semibold mb-3">3. Customer Obligations</h2>
          <p className="leading-relaxed text-justify">
        ...
        <article>
          ...
          <p className="leading-relaxed text-justify">
            ...
            platform does not hold payment funds; funds are transferred directly
        ...
        <article>
          ...
          <p className="leading-relaxed text-justify">
            Return and refund policies vary by vendor. Customers should review the
            vendor’s policy before making a purchase.
          </p>
        </article>
        ...
        <article>
          ...
          <p className="leading-relaxed text-justify">
            ...
            or transactions between vendors and customers.
          </p>
        </article>
